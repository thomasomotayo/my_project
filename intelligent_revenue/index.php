    ...
    <style>
        ...
        .home-body {
            ...
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), 
             url('images/rev2.jfif') no-repeat center center/cover;
    min-height: 100vh;
...
<body class="home-body">
    ...
    <section class="hero">
        ...
        <div class="cta-buttons">
            ...
            <a href="login.php" class="btn btn-outline">Login to Your Account</a>
        </div>
    </section>
    ...
    <footer>
        ...
        <p> Designed by Thomas Omotayo (Ethon Digital Enterprises) </P>
    </footer>
</body>
</html>